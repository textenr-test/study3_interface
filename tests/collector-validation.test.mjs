...
assert.match(source, /function releaseInvalidCompletedSlot/);
assert.match(source, /released_invalid_complete/);
assert.match(source, /slot_invalidated_after_completion/);
